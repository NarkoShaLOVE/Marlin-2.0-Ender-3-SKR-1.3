 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN  //dependent on pin def'n in pins_BIGTREE_SKR_V1.3h
 ...
 */
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       630  // Switched to the Extruder Motor Stepper (Creality 42-40) with 1.0a max.
