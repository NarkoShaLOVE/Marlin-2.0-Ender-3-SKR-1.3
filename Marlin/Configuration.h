...
#define STRING_CONFIG_H_AUTHOR "(TallDonkey, Ender-3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // TH3D Creality Ender-3 PID Settings
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 PID from TH3D Default
  //#define  DEFAULT_bedKp 690.34
  //#define  DEFAULT_bedKi 111.47
  //#define  DEFAULT_bedKd 1068.83

  // My PID Autotune Settings
...
#define NOZZLE_PARK_FEATURE
 ...
 // #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 }  <-- This seems to park it at far left
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 50), (Y_MIN_POS + 50), 20 }  // Park at right front.
...
//
// Disable Audio feedback by setting to 0
